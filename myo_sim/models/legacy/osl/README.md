> **LEGACY** — OSL and assistive/exoskeletal models will move to `myoassist` ([#100](https://github.com/MyoHub/myo_sim/issues/100)). Do not add new dependencies on this path.
